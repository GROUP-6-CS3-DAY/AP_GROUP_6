            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('facility_id') is-invalid @enderror" id="facility_id" name="facility_id" required>
                        ...
                        <option value="{{ $facility->id }}" {{ old('facility_id', $equipment->facility_id) == $facility->id ? 'selected' : '' }}>{{ $facility->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('inventory_code') is-invalid @enderror" id="inventory_code" name="inventory_code" value="{{ old('inventory_code', $equipment->inventory_code) }}" required>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('usage_domain') is-invalid @enderror" id="usage_domain" name="usage_domain" required>
                        ...
                        <option value="{{ $key }}" {{ old('usage_domain', $equipment->usage_domain) == $key ? 'selected' : '' }}>{{ $value }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('support_phase') is-invalid @enderror" id="support_phase" name="support_phase" required>
                        ...
                        <option value="{{ $key }}" {{ old('support_phase', $equipment->support_phase) == $key ? 'selected' : '' }}>{{ $value }}</option>
                        @endforeach
                    </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="capabilities[]" value="{{ $key }}" id="capability_{{ $key }}" 
                                {{ in_array($key, old('capabilities', $equipment->capabilities ?? [])) ? 'checked' : '' }}>
